...
**验收标准**:
- [ ] `docs/principles/testing-principles.md` 加"L1~L5 矩阵执行约束"小节
- [ ] 含 3 条约束：L4 能力不重复在 e2e/ 实现 / L5 能力必须有 e2e spec 承接 / 跨层冗余禁止
- [ ] 与 T-18 的等级原则小节互引
...
**验收标准**:
- [ ] `features/114-ui-e2e-poc/poc-report.md` §7.1 标注"已在 F115 实施"
- [ ] 标注含 F115 对应 task 编号（T-07/T-08/T-09 + T-11）
...
**验收标准**:
- [ ] 仓库根 `README.md` 测试入口更新为 `pnpm test:all`（主仓库 + e2e）
- [ ] 含简短说明："含三层测试（unit / fr-acceptance / e2e）"
- [ ] 与 AGENTS.md §7 引用一致
